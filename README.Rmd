...
The goal of appsilon.ships is to ...

## Installation

You can install the released version of appsilon.ships from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("appsilon.ships")
```
