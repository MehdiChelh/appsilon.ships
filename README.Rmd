...
Currently the dataset is in the package, which is not recommended regarding the initial size of the data (~ 400 MB). This is mainly why the R-CMD check is failing.

However, since this is a homework assignment, I'm keeping it that way to facilitate reproducibility.
